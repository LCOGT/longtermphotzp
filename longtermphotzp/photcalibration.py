...
def parseCommandLine():
    ...
    parser.add_argument('--filters', default=['up', 'gp','rp','ip','zp', 'Y', 'U', 'B', 'V', 'R', 'I'], nargs='+')
    ...
    cameragroup.add_argument('--cameratype', dest='cameratype', default=None, choices=['fs', 'fl', 'fa', 'kb', 'ep', 'sq'],
