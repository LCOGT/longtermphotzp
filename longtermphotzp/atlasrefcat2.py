...
class atlas_refcat2:
    ...
    FILTERMAPPING['Na_D'] = {'refMag': 'rmag', 'colorTerm': 0.0, 'airmassTerm': 0.14, 'defaultZP': 0.0}
    FILTERMAPPING['ip'] = {'refMag': 'imag', 'colorTerm': 0.0, 'airmassTerm': 0.06, 'defaultZP': 0.0}
    FILTERMAPPING['i_narrow'] = {'refMag': 'imag', 'colorTerm': 0.0, 'airmassTerm': 0.14, 'defaultZP': 0.0}
    FILTERMAPPING['zp'] = {'refMag': 'zmag', 'colorTerm': 0.0, 'airmassTerm': 0.04, 'defaultZP': 0.0}
    FILTERMAPPING['z_narrow'] = {'refMag': 'zmag', 'colorTerm': 0.0, 'airmassTerm': 0.14, 'defaultZP': 0.0}
