...
class atlas_refcat2:
    ...
    FILTERMAPPING['B'] = {'refMag':  'B'   , 'colorTerm': 0.0, 'airmassTerm': 0.27, 'defaultZP': 0.0}
    FILTERMAPPING['V'] = {'refMag':  'V'   , 'colorTerm': 0.0, 'airmassTerm': 0.15, 'defaultZP': 0.0}
    FILTERMAPPING['R'] = {'refMag':  'R'   , 'colorTerm': 0.0, 'airmassTerm': 0.11, 'defaultZP': 0.0}
    FILTERMAPPING['I'] = {'refMag':  'I'   , 'colorTerm': 0.0, 'airmassTerm': 0.07, 'defaultZP': 0.0}
